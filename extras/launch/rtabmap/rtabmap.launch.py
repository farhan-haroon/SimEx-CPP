...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('gui_cfg',  default_value='~/maps2/rtabmap_gui.ini',  description='Configuration path of rtabmap_viz.'),
        ...
        DeclareLaunchArgument('database_path',  default_value='~/maps2/rtabmap.db',  description='Where is the map saved/loaded.'),
        ...
        DeclareLaunchArgument('camera_info_topic',   default_value='/depth_camera/depth/camera_info',            description=''),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/velodyne_points', description=''),
